...
people table schema id name age You should return all people fields where their age is over 50 and order by the age descending
...
people table schema
id name age select table schema
age_sum (sum of ages)

SELECT SUM(age) AS age_sum 
FROM people;

3. For this challenge you need to create a simple MIN / MAX statement that will return the Minimum
...
5. For this challenge you need to create a simple GROUP BY statement, you want to 
group all the people by their age and count the people who have the same age.

SELECT age, COUNT(*) people_count
FROM people
GROUP BY age

6. For this challenge you need to create a simple HAVING statement, you want to count how many people 
